            ...
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-xs-12 col-sm-8">
                        <div class="title text-center"><h3>GỬI LIÊN HỆ VỀ 4MEN®</h3></div>
                    ...
                    <div class="col-xs-12 col-sm-4 tt-right">
                        <div class="title text-center col-xs-12"><h3>THÔNG TIN LIÊN HỆ VỀ 3T</h3></div>
                        <div class="col-xs-12">
                            <div class="row address">
                                ...
                                <div class="col-xs-11 right" style="padding-right: 0">
                                       ...
                                       <div class="media-body">Chưa có</div>
                                </div>
                            </div>
                            ...
                            <div class="row phone">
                                ...
                                <div class="col-xs-11 right" style="padding-right: 0">
                                    ...
                                    <div class="media-body">123456</div>
                                </div>
                            </div>
                            <div class="row mail">
                                <div class="col-xs-1 left">
                                ...
                                <div class="col-xs-11 right" style="padding-right: 0">
                                    ...
                                    <div class="media-body">lttuan@student.ctuet.edu.vn</div>
                                </div>
                            </div>
                    </div>
                        <div class="col-xs-12 foooter">
                            <div class="row"><p>Thương hiệu thời trang nam 4MEN® Chuyên các dòng sản phẩm thời trang nam: Quần
                                    jean, quần tây, quần kaki, áo sơ mi, áo khoác, áo vest, áo thun, phụ kiện nam,...</p></div>
                        </div>
