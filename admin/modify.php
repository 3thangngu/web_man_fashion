                ...
                <td>
                     <table class="table wrap-value">
                         <tbody>
                            ...
                            <!--  <tr>
                                 <td>
                                      <input type="text" name="" class="form-text text-input text-name" placeholder="Tên Shop Của Bạn">
                                 </td>
                                 <td>
                                     <div class="edit text-right"><i class="glyphicon glyphicon-floppy-save"></i>Lưu</div>
                                 </td>
                                 <td>
                                     <div class="detele text-right"><i class="glyphicon glyphicon-remove"></i>Xóa</div>   
                                 </td>
             ...
             <!--  -->
              <tr class="wrap-adress">
                ...
                <td>
                    <table class="table wrap-value">
                         <tbody>
                            <?php if ( array_key_exists('adress', $array_information) ) {
                                // echo $array_information['phone'];
                                $array_adress = explode("$%^$%^", $array_information['adress']);
                                for ($i=1; $i < count( $array_email ); $i++) { 
